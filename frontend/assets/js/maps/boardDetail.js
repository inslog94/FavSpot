import { CURRENT_PINS } from "./data.js";
    ...
    .then(data => {
      ...
      data
        ...
        .forEach((pin, index) => {
          ...
          postElement
            .classList
            .add('port-post', 'clearfix', 'bg-white');
      ...
      data
        ...
        .forEach(function (comment) {
          ...
          if (comment.user.profile_img !== null && comment.user.profile_img !== undefined) {
            imgTag.src = comment.user.profile_img; // 실제 이미지 URL
          } else {
            imgTag.src = 'https://everyplacetest.s3.ap-northeast-2.amazonaws.com/dev/user_default.png'; // 기본 이미지 URL
          }
