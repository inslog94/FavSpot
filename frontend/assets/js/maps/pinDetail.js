...
export function pinDetail() {  
          ...
          function fetchUserInfo() {
            return fetch(`${origin}/user/me/`, {
              ...
              .then((data) => {
                ...
                // 데이터 저장
                loginUserEmail = data.User.email;
                // 보드 목록 저장
          ...
          function displayPinDetail() {
            fetch(`${origin}/pin/${PIN_DETAIL.placeId}/`, {
              ...
              .then((data) => {
                ...
                const modalCategoryElement =
                  document.getElementById("modalCategory");
                const modalPinCountElement =
                  document.getElementById("modalPinCount");
                const modalUpdatedAtElement =
                  document.getElementById("modalUpdatedAt");
                ...
                const subscribeIconElement =
                  document.querySelector(".subscribe-icon");
                ...
                if (data.results.pin.thumbnail_img) {
                  ...
                  subscribeIconElement.src =
                    "https://everyplacetest.s3.ap-northeast-2.amazonaws.com/dev/default_img.png"; // 기본 사진 위치 지정
                }
              })
              .catch((error) => {
            ...
            fetch(`${origin}/pin/${PIN_DETAIL.placeId}/?page=${page}`, {
              ...
              .then((data) => {
                ...
                data.results.pin_contents.forEach((pinContent) => {
                  ...
                  // 삭제 버튼 생성
                  if (loginUserEmail && pinContent.email === loginUserEmail) {
          ...
          document
            ...
            .addEventListener("click", function () {
              let pinCreationElement =
                document.getElementById("pinCreationSteps");
          ...
          document
            ...
            .addEventListener("click", function () {
              ...
              if (currentStep === 2) {
                document.getElementById("saveBackButton").style.display = "none"; // 뒤로 가기 버튼을 숨김
                document.getElementById("createButton").style.display =
                  "inline-block"; // 첫번째, 두번째 단계에 모두 저장 버튼이 나타남
          ...
          document
            ...
            .addEventListener("click", function () {
              ...
              // 선택된 보드 ID 추가
              const selectedBoard =
                document.getElementById("boardSelection").value;
